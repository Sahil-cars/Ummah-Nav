...
export const SURAHS = [
    ...
    { number: 3, name: "آل عمران", englishName: "Aal-E-Imran" },
    ...
    { number: 14, name: "ابراهيم", englishName: "Ibrahim" },
    ...
    { number: 34, name: "سبإ", englishName: "Saba" },
    ...
    { number: 61, name: "الصف", englishName: "As-Saf" },
    ...
    { number: 76, name: "الانسان", englishName: "Al-Insan" },
    { number: 77, name: "المرسلات", englishName: "Al-Mursalat" },
    { number: 78, name: "النبإ", englishName: "An-Naba" },
